  ...
  return (
    <ActionForm action={upsertBanner} submitLabel="Save banner" size="sm">
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        <Field
          label="Image"
          hint="A path like /images/events/navratri-1.jpg, or a full https URL. Author it at 1800×600 and keep anything important in the middle — the carousel crops to 3:1 on desktop and 2:1 full-bleed on a phone. Leave blank to use the gradient."
        >
